	...
	<body>
		...
		<div class="nav" role="navigation">
			<ul>
				...
				<li><g:link class="list" action="index" id="${tekMessageInstance?.evento?.id}"><g:message code="default.list.label" args="[entityName]" /></g:link></li>
			</ul>
		</div>
		<div id="create-tekMessage" class="content scaffold-create" role="main">
			<h1>${tekMessageInstance?.evento?.id} - Fórum - Nova Mensagem</h1>
			...
			<g:form url="[resource:tekMessageInstance, action:'save']" >
				...
				<fieldset class="buttons">
					<g:hiddenField name="evento.id" value="${tekMessageInstance?.evento?.id}"/>
